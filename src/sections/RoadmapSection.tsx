  ...
  return (
    <section id="studio" className="relative py-24 md:py-32" style={{ zIndex: 2 }}>
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="relative overflow-hidden rounded-3xl border border-black/5 bg-white/60 p-8 md:p-14">
          <div
          ...
          <div className="relative z-10 mx-auto max-w-[640px] text-center">
            <h2 className="text-[36px] font-semibold leading-tight tracking-[-2px] text-[#121212] md:text-[56px]">
              From private chat
              <br />
            ...
            <p className="mx-auto mt-4 max-w-[420px] text-sm leading-relaxed text-[#888888] md:text-base">
              ...
              short-form video as we scale with investors.
            </p>
          </div>
        </div>
      </div>
